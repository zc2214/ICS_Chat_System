...
\setbeamertemplate{background}{%
	\put(5,-270){%
		\parbox{1.16\linewidth}{\tiny Presentation Project: Chat System - GUI \& File System \hfill \raggedleft\insertframenumber~/ \inserttotalframenumber}
	}
...
\setbeamertemplate{frametitle}
{
	...
	\begin{beamercolorbox}[sep=0.3cm,ht=1.8em,wd=\paperwidth]{frametitle}
		...
		\hfill
		\raisebox{-1cm}{\includegraphics[scale=0.05,trim={0cm 0cm 0 0cm},clip]{logo2_NYU.jpg}}
		\vskip-0.8ex%
	\end{beamercolorbox}
}
...
\title{Presentation Project: Chat System\\-\\GUI \& File System}

\author{James Chen \& Shanglin Yang}


\institute{\includegraphics[scale=0.4]{logo_NYU.png}}

\date{Instructors: Prof. Xianbin Gu \& Dr. Wen Yin}

%\logo{\includegraphics[scale=0.04]{logo2_NYU.jpg}}
